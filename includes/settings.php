		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				<tbody>
					...
					<tr valign="top">
						<th scope="row" valign="top">
							<?php _e('One Time Sign-up Fee', 'pippin_stripe'); ?>
						</th>
						<td>
							...
							<label class="description" for="stripe_settings[one_time_fee]"><?php _e('Check this charge customers a one time fee when signing up for a recurring subscription.', 'pippin_stripe'); ?></label>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row" valign="top">
							<?php _e('Fee Amount', 'pippin_stripe'); ?>
						</th>
						<td>
							...
							<label class="description" for="stripe_settings[fee_amount]"><?php _e('The one time fee amount in $.', 'pippin_stripe'); ?></label>
						</td>
					</tr>
				</tbody>
			</table>
